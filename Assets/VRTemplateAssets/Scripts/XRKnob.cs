...
namespace Unity.VRTemplate
{
    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("What axis the handle should respond to")]
        ...
        void SetKnobRotation(float angle)
        {
            ...
            if (m_Handle != null)
            {
                Vector3 rotationAngle = new Vector3(angle * rotationMask.x, angle * rotationMask.y, angle * rotationMask.z);

                m_Handle.localEulerAngles = rotationAngle;
